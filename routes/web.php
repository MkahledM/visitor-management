...
Route::get('visit', [VisitController::class, 'index'])->name('visitor');

Route::get('visit/fetchall', [VisitController::class, 'fetch_all'])->name('visitor.fetchall');

Route::get('visit/create', [VisitController::class, 'create'])->name('visitor.add');

Route::post('visit/add_validation', [VisitController::class, 'store'])->name('visitor.add_validation');

 Route::resource('visit', VisitController::class);
Route::delete('visit/{id}', [VisitController::class, 'destroy']);
// Route::get('visit/search', [VisitController::class, 'index2']);
